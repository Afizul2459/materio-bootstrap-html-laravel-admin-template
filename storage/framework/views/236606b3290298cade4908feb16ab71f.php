  ...
  <div class="col-md-12">
    <div class="nav-align-top">
      <ul class="nav nav-pills flex-column flex-md-row mb-6 gap-2 gap-lg-0">
        <li class="nav-item"><a class="nav-link" href="<?php echo e(url('pages/account-settings-account')); ?>"><i class="ri-group-line me-1_5"></i> Account</a></li>
        <li class="nav-item"><a class="nav-link" href="<?php echo e(url('pages/account-settings-notifications')); ?>"><i class="ri-notification-4-line me-1_5"></i> Notifications</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-12">
          ...
          <div class="card-body">
            ...
            <div class="d-flex mb-4 align-items-center">
              <div class="flex-shrink-0">
                <img src="<?php echo e(asset('assets/img/icons/brands/twitter.png')); ?>" alt="twitter" class="me-4" height="32">
              </div>
              <div class="flex-grow-1 row align-items-center">
                <div class="col-7">
