...
<div class="row gy-6">
  ...
  <div class="col-md-12 col-lg-4">
    <div class="card">
      ...
      <img src="<?php echo e(asset('assets/img/illustrations/trophy.png')); ?>" class="position-absolute bottom-0 end-0 me-5 mb-5" width="83" alt="view sales">
    </div>
  </div>
  <!--/ Congratulations card -->
        ...
        <ul class="p-0 m-0">
          <li class="d-flex mb-6">
            <div class="avatar flex-shrink-0 bg-lightest rounded me-3">
              <img src="<?php echo e(asset('assets/img/icons/misc/zipcar.png')); ?>" alt="zipcar">
            </div>
          ...
          <li class="d-flex mb-6">
            <div class="avatar flex-shrink-0 bg-lightest rounded me-3">
              <img src="<?php echo e(asset('assets/img/icons/misc/bitbank.png')); ?>" alt="bitbank">
            </div>
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              <div class="me-2">
          ...
          <li class="d-flex">
            <div class="avatar flex-shrink-0 bg-lightest rounded me-3">
              <img src="<?php echo e(asset('assets/img/icons/misc/aviato.png')); ?>" alt="aviato">
            </div>
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              <div class="me-2">
